...
export function formatTokenInfo(token: CoinAssetDataExtended): string {
    ...
    const priceChange1h = token.priceChange1h === 0 ? token.priceChange1h.toFixed(2) : (token.priceChange1h! > 0 ? "+" + token.priceChange1h?.toFixed(2) : token.priceChange1h?.toFixed(2)) + "%";
    const priceChange24h = token.priceChange24h === 0 ? ` ${token.priceChange24h.toFixed(2)}%` : (token.priceChange24h! > 0 ? "+" + token.priceChange24h?.toFixed(2) : token.priceChange24h?.toFixed(2)) + "%";
